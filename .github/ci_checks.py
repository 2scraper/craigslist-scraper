...
#
# A sibling repo in this family needs its image CDN's host in here, because
# that site names every image with 32 hex characters and its fixtures trip
# the grep. Craigslist does not: its image ids are the site's own
# `00J0J_hrcN59kWjJ0_0co0gw` shape and its posting ids are 22 characters of
# base64url, neither of which matches. So this list stays at the generic
# entries, and a bare 32-hex string anywhere in this repo still fails —
